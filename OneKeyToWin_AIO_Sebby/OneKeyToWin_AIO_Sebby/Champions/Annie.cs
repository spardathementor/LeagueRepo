...
namespace OneKeyToWin_AIO_Sebby
{
    class Annie
    {
        ...
        public void LoadOKTW()
        {
            ...
            R.SetSkillshot(0.22f, 200f, float.MaxValue, false, SkillshotType.SkillshotCircle);
            FR.SetSkillshot(0.22f, 200f, float.MaxValue, false, SkillshotType.SkillshotCircle);
