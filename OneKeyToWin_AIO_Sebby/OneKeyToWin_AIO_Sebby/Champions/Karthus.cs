...
namespace OneKeyToWin_AIO_Sebby.Champions
{
    class Karthus : Base
    {
        public Karthus()
        {
            ...
            Q.SetSkillshot(0.95f, 140f, float.MaxValue, false, LeagueSharp.Common.SkillshotType.SkillshotCircle);
            W.SetSkillshot(0.5f, 50f, float.MaxValue, false, LeagueSharp.Common.SkillshotType.SkillshotCircle);
